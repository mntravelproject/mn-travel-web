...
export function CTASection() {
  return (
    <section className="max-w-[1320px] mx-auto px-6 lg:px-10 mt-32 mb-32">
      <ScaleIn from={0.95} duration={0.75}>
          ...
          <div className="relative px-10 py-24 lg:px-20 lg:py-32 max-w-2xl">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-white/40 hover:border-white text-white px-7 py-3.5 text-[14px] tracking-tight transition-colors"
              >
